...
fn display_dmi_profiles_print_cli_table(target: &CfhdbDmiInfo) {
    ...
    let table = table_struct
        .table()
        .title(vec![
            t!("dmi_table_profile_codename").cell().bold(true),
            t!("dmi_table_name_i18n_desc").cell().bold(true),
            t!("dmi_table_name_license").cell().bold(true),
            t!("dmi_table_name_priority").cell().bold(true),
            t!("dmi_table_name_experimental").cell().bold(true),
            t!("dmi_table_name_installed").cell().bold(true),
        ])
        .bold(true);
